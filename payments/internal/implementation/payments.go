...
import (
	...
	"github.com/andreistefanciprian/gomicropay/payments/internal/producer"
...
func NewPaymentsImplementation(db db.PaymentsRepository, producer sarama.SyncProducer, tracer trace.Tracer, logger *logrus.Logger) *Implementation {
